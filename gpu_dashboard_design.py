...
def calculate_scores(
    ...
    group_weights = {'technical': 0.35, 'economic': 0.25, 'operational': 0.10, 'environmental': 0.10, 'sanction': 0.20}
    normalized = {}
...
def main():
    ...
    if df_source is None or df_source.empty:
        ...
        return
    # Категория потребителя
    consumer_categories = ['Промышленность', 'Энергетика', 'Коммуналка', 'Без категории']
