...
def main():
    ...
    st.markdown(
        ...
        html, body, [class*="st-"] {
            background-color: #1e2430; /* тёмно‑серый фон вместо почти чёрного */
            color: #cbd5e1;
        ...
        /* Цвет текста и треков слайдеров */
        div[data-testid="stSlider"] div {
            color: #cbd5e1;
        }
        /* Попытка изменить цвет трека и ползунка для слайдеров */
        ...
        /* Цвет заголовков таблиц/карточек */
        .stDataFrame {
            background-color: #253148;
        }
        </style>
